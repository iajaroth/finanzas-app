...
export function apiRouter() {
  ...
  r.put('/settings', (req, res) => {
    const b = req.body || {};
    const allowed = ['currency', 'monthly_budget', 'auto_approve', 'sender_filters', 'sync_days', 'azure_client_id', 'azure_client_secret', 'last_sync_at', 'bccr_email', 'bccr_token', 'usd_rate_manual'];
